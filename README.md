...
- Загруженная пользователем фотография обрабатывается классификационной моделью (Effecient Net [код по ссылке: https://colab.research.google.com/drive/1RD4WpHWtM9e47fdcExqtO2NNJnccORnI?usp=sharing])
